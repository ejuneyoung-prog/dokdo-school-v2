...
try:
 with sync_playwright() as pw:
  ...
  page.click('#start-placement');page.select_option('#age-band','14-16');page.click('#age-form button[type=submit]')
  check('Middle-school placement begins with island geography',page.evaluate('DokdoApp.lesson.item.unit===2'))
